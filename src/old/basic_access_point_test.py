...
#Scan for connections and loop through each found connection
    #If network name is saved in the json file...attempt to connect 3 times

    #If failure...continue to next connection

    #If success set the success flag and skip over the access point code
...
print("Created the access point...")
